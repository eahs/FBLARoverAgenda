...
namespace FBLARoverAgenda.ViewModels
{
    ...
    [DataContract]
    public class AllTeachersListPageViewModel : BaseViewModel
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="AllTeachersListPageViewModel"/> class.
        /// </summary>
        public AllTeachersListPageViewModel()
        {
        }
        #endregion
