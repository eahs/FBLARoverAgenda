...
namespace FBLARoverAgenda.ViewModels
{
    ...
    [DataContract]
    public class SchoolCalendarViewModel : BaseViewModel
    {
        #region Fields

        private static SchoolCalendarViewModel myAddressViewModel;
        ...
        /// </summary>
        public static SchoolCalendarViewModel BindingContext =>
            myAddressViewModel = PopulateData<SchoolCalendarViewModel>("detail.json");
